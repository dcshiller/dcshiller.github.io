...
var author$project$Techniques$FrontLoaded = {$: 'FrontLoaded'};
var author$project$Techniques$InPerson = {$: 'InPerson'};
var author$project$Techniques$Introverted = {$: 'Introverted'};
var author$project$Techniques$Large = {$: 'Large'};
var author$project$Techniques$Medium = {$: 'Medium'};
var author$project$Techniques$OverThinking = {$: 'OverThinking'};
var author$project$Techniques$Small = {$: 'Small'};
var author$project$Techniques$TimeLimited = {$: 'TimeLimited'};
var author$project$Techniques$Virtual = {$: 'Virtual'};
...
var author$project$Techniques$allTags = _List_fromArray(
	[author$project$Techniques$FrontLoaded, author$project$Techniques$Introverted, author$project$Techniques$Small, author$project$Techniques$Medium, author$project$Techniques$Large, author$project$Techniques$Virtual, author$project$Techniques$InPerson, author$project$Techniques$TimeLimited, author$project$Techniques$OverThinking]);
var author$project$Techniques$techniques = _List_fromArray(
	[
		{
		...
		tags: _List_fromArray(
			[author$project$Techniques$Virtual, author$project$Techniques$InPerson, author$project$Techniques$FrontLoaded, author$project$Techniques$Small, author$project$Techniques$Medium, author$project$Techniques$Large]),
		title: 'Brain Writing'
	},
		{
		...
		tags: _List_fromArray(
			[author$project$Techniques$TimeLimited, author$project$Techniques$Virtual, author$project$Techniques$InPerson, author$project$Techniques$Small, author$project$Techniques$Medium, author$project$Techniques$Large, author$project$Techniques$OverThinking]),
		...
		tags: _List_fromArray(
			[author$project$Techniques$Virtual, author$project$Techniques$Small, author$project$Techniques$Medium, author$project$Techniques$Large]),
		title: 'Online Brainstorming'
	}
	]);
var author$project$Main$init = {possibleSelections: author$project$Techniques$allTags, selectables: author$project$Techniques$techniques, selections: author$project$Techniques$allTags};
...
var author$project$Main$Deselect = function (a) {
	return {$: 'Deselect', a: a};
};
var author$project$Main$Select = function (a) {
	return {$: 'Select', a: a};
};
var author$project$Main$tagToString = function (tag) {
	switch (tag.$) {
		case 'Virtual':
			return 'Virtual';
		case 'InPerson':
			return 'In Person';
		case 'FrontLoaded':
			return 'Teams who are influenced by the first ideas presented';
		case 'Introverted':
			return 'Introverted team members';
		case 'Small':
			return 'Small teams';
		case 'Medium':
			return 'Medium teams';
...
var author$project$Main$renderTag = F2(
	function (currentSelections, tag) {
		var selected = A2(
			elm$core$List$any,
			function (s) {
				return _Utils_eq(s, tag);
			},
			currentSelections);
		var onClick = selected ? author$project$Main$Deselect(tag) : author$project$Main$Select(tag);
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					author$project$Main$tagToString(tag))
				]));
	});
...
var author$project$Main$renderControls = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			elm$core$List$map,
			author$project$Main$renderTag(model.selections),
			model.possibleSelections));
};
var elm$html$Html$p = _VirtualDom_node('p');
var author$project$Main$renderSelectable = function (selectable) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('selectable')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text(selectable.title)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
var author$project$Main$includesTag = F2(
...
var author$project$Main$selectedSelectables = function (model) {
	return A2(
		elm$core$List$filter,
		function (s) {
			return A2(
				elm$core$List$all,
				author$project$Main$includesTag(model.selections),
				s.tags);
		},
		model.selectables);
};
var author$project$Main$renderSelectables = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('selectables')
			]),
		A2(
			elm$core$List$map,
			author$project$Main$renderSelectable,
			author$project$Main$selectedSelectables(model)));
};
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$renderControls(model),
				author$project$Main$renderSelectables(model)
			]));
};
